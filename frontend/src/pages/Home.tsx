                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">
                      {sessions.reduce(
                        (acc, s) => acc + (s.selectedFiles?.length || 0),
                        0
                      )}
                    </div>
                ...
                {!loading && !error && sessions.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-600 text-center max-w-md mb-6">
                      Get started by creating your first test session. Browse
                      your repositories and generate AI-powered tests.
                    </p>
                    <RepoDialog
                      trigger={
                  ...
                  <div className="space-y-4">
                    {sessions.map((session) => (
                      <Card
                        ...
                        className="border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 bg-white"
                      >
                        <CardContent className="p-6">

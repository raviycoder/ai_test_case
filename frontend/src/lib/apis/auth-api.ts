...
export const authAPI = {
  ...
  getSession: async () => {
    ...
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/users/session`, { withCredentials: true,
      headers: { 'Cookie': `${betterAuthToken || ''}; ${betterAuthSession || '__Secure-better-auth.session_token=bTsl9NpJe1TkotaiwqwikjbwjaxNMivD.urKGh1MVqe5t1J9aL1MastcLr6oR1rXf6UpgfgwgOgc%3D; __Secure-better-auth.session_data='}` }
     });
